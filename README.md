...
| A-2 | Aplicar el factor de demanda por tipo de carga (alumbrado, contactos, equipo), a criterio del ingeniero y con justificación del Art. 220; motores, A/C y calefacción fija al 100 %. | 220-40, 220-50, 220-51 | `ElFactorDeDemanda…`, `R12_…`, `R17_…` |
