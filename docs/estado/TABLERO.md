...
- Asignar cada circuito a su canalización (columna «Canal.»). Configurar cada una —nombre, tipo,
  tubo; nace EMT— en la tarjeta «Canalizaciones»; la propia se guarda con su circuito.
- Pruebas: 169 en `PowerNode.Web.Tests` (20 del documento de pruebas del 2026-09-23).
