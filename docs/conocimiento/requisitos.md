...
| C-6 | Capturar un motor por sus HP en Motor / A/C. Tomar la FLC de la tabla por los polos (1 y 2: monofásico; 3: trifásico) y la tensión del circuito; ofrecer solo los HP que trae la tabla. Cargar al cuadro FLC × tensión (× √3). | 430-6(a), Tablas 430-248 y 430-250 | `I15_…` |
...
| P-5 | Proteger el derivado de un motor con el porcentaje de la Tabla 430-52 para interruptor de tiempo inverso (250 %) y el tamaño inmediato superior. | 430-52(c)(1) y su Excepción 1 | `I15_…` |
...
| A-4 | Avisar si el principal es menor que el derivado más grande. Si ese derivado es de un motor, decir hasta cuánto permite subir el principal 430-62(a). | 430-62(a) | `M03_…`, `I15_…` |
...
| A-12 | Sumar los motores en HP por fase: 125 % de la FLC del mayor + 100 % de los demás, con el F.D. de motores; su FLC en la caída fasorial. Máximo de la protección: la mayor de motor + la FLC de los demás + lo que 215-3 pide para la otra carga; avisar si se excede. | 430-24, 430-26, 430-62(a), 430-63 | `I15_…`, `M09_…` |
