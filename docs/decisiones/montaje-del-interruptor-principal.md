...
**PROPUESTA · Claude · 2026-09-25** — la pidió David al ver el gabinete en multifilar (I-67):
...
|---|---|---|
| 2 o 3 | **Zócalo propio**, abajo: no ocupa espacios numerados. **En espacios del gabinete**: se come tantos espacios como polos, como un derivado. | En espacios, los últimos pares: 20-22-24 en un tablero de 24 y 3 barras; 22-24 con 2 barras. |
| 1 (1F-2H) | Solo **en un espacio**. No hay zócalo. | El último espacio. |
...
- **1F-2H y zapatas.** Un centro de carga de una barra casi siempre viene protegido desde otro
  tablero. Queda a decisión de David si en 1F-2H «zapatas principales» pasa a ser el valor por
  omisión (hoy lo es «interruptor principal» en todos los sistemas).

## Cómo se dibuja (multifilar, I-67)

- **Zapatas principales**: arriba de las barras, un borne por barra con la acometida entrando. Sin
  interruptor.
